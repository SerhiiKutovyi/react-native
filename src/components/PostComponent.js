...
export default function PostComponent({
  ...
  const containerStylePosts = isLastItem
    ? styles.lastItemContainer
    : styles.itemContainer;
  const containerStyleProfile = isLastItem
    ? styles.lastItemContainerProfile
    : styles.itemContainer;

  return (
    <View
      style={forProfileScreen ? containerStyleProfile : containerStylePosts}
    >
      ...
      <View style={styles.iconsContainer}>
        <View style={styles.iconsContainer}>
          <TouchableOpacity
            activeOpacity={0.8}
            style={styles.innerWrapperIcons}
